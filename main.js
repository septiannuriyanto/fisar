...
const { copy17Ra, copy221 } = require("./dist/src/utils/fileClient"); // Import download function
const {
  sendFilterUsageReminder,
} = require("./dist/src/reminders/grupGLFaoReminder"); // Import download function
const {
  checkAndNotifyPoFuelSummaryTest,
} = require("./dist/src/jobs/checkAndNotifyPoFuelSummary"); // Import download function
...
function startBot() {
  if (!botProcess) {
    botProcess = spawn("node", ["dist/src/index.js"], {
      cwd: __dirname,
      shell: true,
    });
